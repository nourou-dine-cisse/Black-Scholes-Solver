...
volatilité du sous-jacent et l’existence d’un taux d’intérêt sans risque connu à
...
Le langage C++ est choisi pour ses performances et sa structuration.

\subsection{Affichage des résultats}

Les résultats sont visualisés à l’aide de la bibliothèque SDL.

\section{Résultats numériques}

Les résultats obtenus sont conformes aux propriétés théoriques attendues. La
convergence des schémas est observée lorsque les pas de discrétisation diminuent.

\section{Difficultés rencontrées}

Les difficultés concernent principalement la gestion des conditions aux limites,
l’indexation matricielle et la stabilité numérique.

\section{Conclusion}

Ce projet met en œuvre des méthodes numériques pour résoudre l’équation de
Black--Scholes. La méthode de Crank--Nicholson offre un bon compromis entre
précision et stabilité. L’architecture développée permet des extensions futures.
